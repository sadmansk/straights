...
OBJECTS = main.o Deck.o GameView.o Game.o GameController.o Card.o Player.o Subject.o ComputerPlayer.o HumanPlayer.o Command.o PlayerGui.o
EXEC = straights
...
main.o : main.cpp
GameView.o : GameView.h GameView.cpp Game.o Observer.h GameController.o Command.o PlayerGui.o
